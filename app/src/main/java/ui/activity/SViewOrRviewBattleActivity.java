...
//        recycle_pubu.addItemDecoration(decoration);
    ...
    class HomeAdapter extends RecyclerView.Adapter<SViewOrRviewBattleActivity.HomeAdapter.MyViewHolder>
    {

        @Override
        public SViewOrRviewBattleActivity.HomeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            SViewOrRviewBattleActivity.HomeAdapter.MyViewHolder holder = new SViewOrRviewBattleActivity.HomeAdapter.MyViewHolder(LayoutInflater.from(SViewOrRviewBattleActivity.this).inflate(R.layout.item_home, parent, false));
            return holder;
        }

        @Override
        public void onBindViewHolder(SViewOrRviewBattleActivity.HomeAdapter.MyViewHolder holder, int position)
        {
